...
//Project 1: TTS Polak
var description1 = 'TTS Polak, the aluminum foundry of Festool, had been loosing millions since its integration into the TTS group. The situation worsened after new large investments, draining considerable cash and management resources for a none-core business, exhausting 3 managing directors in just 4 years.';
...
var description3 = 'Selling a company is always an exciting project. Selling the company whilst restructuring it brings everything to a higher dimension. You can add additional factors, such as a high dependence from the selling company on delivered parts';
...
var lesson4 = '<li>Data is too important and valuable to be left in the single care of the IT department</li><li>Master Data Management is a heavy but healthy process to follow</li><li>You don&#39;t need to start big, but you need to start fast</li>';
...
var keySolutions5 = '<li>Explained the idea and proposed several implementation scenarios</li><li>Advocated for a clear mission statement with board endorsements</li><li>Proposed several implementation concepts</li>';
var output5 = 'Festool&#39;s COO and his team were persuaded to launch a FabLab in its facilities. When I handed over the concepts for implementation, the expectations were set, the way clear. Now time will show whether it will be accepted by the organization.';
var lesson5 = '<li>The immense potential of digital production capabilities</li><li>The tremendous potential of <em>agile development and collaborative methods</em>, ... </li><li>... but also their disruptive effects on an organizational structure</li>';
